...
Future<Stream<Uint8List?>?> startRecording() async {
  ...
  if (platform.isAndroid || platform.isIOS) {
    ...
    micPermissionGranted = micPermissionStatus == PermissionStatus.granted;
  } else {
    micPermissionGranted = true;
  }

  if (micPermissionGranted) {
    UniversalMicStreamPlatform.instance.startRecording();
...
Future<void> stopRecording() async {
  return await UniversalMicStreamPlatform.instance.stopRecording();
}
