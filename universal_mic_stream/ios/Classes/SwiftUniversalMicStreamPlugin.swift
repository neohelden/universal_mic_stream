...
@available(iOS 9.0, *)
public class SwiftUniversalMicStreamPlugin: NSObject, FlutterPlugin, FlutterStreamHandler {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "neohelden.com/universal_mic_stream", binaryMessenger: registrar.messenger())
        let eventChannel = FlutterEventChannel(name: "neohelden/com.audio_stream", binaryMessenger: registrar.messenger())
        let instance = SwiftUniversalMicStreamPlugin()
